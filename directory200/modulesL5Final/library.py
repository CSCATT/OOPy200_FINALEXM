...
from directory200.modulesL5Final.structureDriver import IStructureDriver
from directory200.modulesL5Final.observer import Observer, Subject

# инициализация логирования
my_log_lib = logging.getLogger("library")
...
class Book(Subject):
	...
	def __valid_field_record (kwargs):
		...
		"""
		# в качестве id используется ISBN, УДК, ББК и др. индентификационные обозначения
		NAME_COLUMN = ("id",
					   "last_name",
					   "first_name",
					   "title",
...
class Library(IStructureDriver, Observer):
	...
	def update (self):
		...
		self.save()
		my_log_lib.info(f"Данные в библиотеке обновлены")